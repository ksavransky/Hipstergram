...
post8 = Post.create(image_url: "http://res.cloudinary.com/ksavransky/image/upload/v1473441958/post6_indsye.jpg", caption: "I have a whole one every morning", user_id: 1)
post9 = Post.create(image_url: "http://res.cloudinary.com/ksavransky/image/upload/v1473441957/post10bacon_rtixba.jpg", caption: "like dog treats for humans", user_id: 1)
post10 = Post.create(image_url: "http://res.cloudinary.com/ksavransky/image/upload/v1473441952/post4_xyibrg.jpg", caption: "found this recipe on a note on the sidewalk.", user_id: 1)
...
post12 = Post.create(image_url: "http://res.cloudinary.com/ksavransky/image/upload/v1473441950/post11pbr_uoyjpn.jpg", caption: "why is this a thing still", user_id: 2)
...
post20 = Post.create(image_url: "http://res.cloudinary.com/ksavransky/image/upload/v1473441934/post17pickledfood_xdq5y8.jpg", caption: "look at my closet!", user_id: 10)
...
post24 = Post.create(image_url: "http://res.cloudinary.com/ksavransky/image/upload/v1473441929/post19homebrewedbeer_fgrx3k.jpg", caption: "home brew beer? got that!", user_id: 1)
...
post37 = Post.create(image_url: "http://res.cloudinary.com/ksavransky/image/upload/v1473441924/post33radiohead_hgahp1.jpg", caption: "OG Hipster Gods.", user_id: 1)
